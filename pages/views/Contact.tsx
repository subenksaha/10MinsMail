			...
			<Content style={{margin: '50px 100px', backgroundColor: '#FFF'}}>
				<Row>
					...
					<Col span={16}>
						...
						<p>Your privacy is important to us. It is 10 Mins Mail's policy to respect
							your privacy regarding any information we may collect from you across our
							website, <a href='http://10minsmail.com'>http://10minsmail.com</a>, and
						...
						<p>Our website may link to external sites that are not operated by us. Please
